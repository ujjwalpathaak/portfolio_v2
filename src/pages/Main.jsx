...
const Main = () => {
  ...
  return (
    <div className="main-content flex h-[100vh] w-[100vw] flex-col px-8 py-10 text-justify font-averia lg:flex-row lg:px-28 lg:py-0">
      {/* Left Sidebar */}
      ...
      >
        <section id="whoami" className="text-text">
          ...
          <div className="flex justify-center">
            <img
              src={config.personalInfo.profile}
              alt="profile"
              className="mb-10 h-1/2 w-1/2"
            />
          </div>
          <HighlightText
